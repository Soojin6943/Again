...
class Content(models.Model):
    ...
    money=models.IntegerField(max_length=100, null=True, blank=True)
    start_date = models.DateField(null=True, blank=True)
    end_date = models.DateField(null=True, blank=True)
    enroll_start_date = models.DateField(null=True, blank=True)
    enroll_end_date = models.DateField(null=True, blank=True)
